    ...
    <div className="p-4">
        ...
        <CardContent className="p-6 text-center">
          <div className="flex flex-col items-center gap-2">
            ...
            <p className="text-sm text-muted-foreground">
              Click to add a new academic activity with necessary information and
              save it
            </p>
          </div>
        </CardContent>
      ...
      <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        <DialogContent className="max-w-lg">
          <DialogHeader>
            <DialogTitle>Add a new academic activity</DialogTitle>
          </DialogHeader>
          <form onSubmit={handleSubmit}>
            <div className="space-y-4">
              <p className="text-gray-600 dark:text-gray-300 text-sm">
                Please enter the title of the new academic activity you want to add.
                For example: Project , Thesis etc.
              </p>
              <Input
                type="text"
                placeholder="Enter academic activity title"
                value={title}
            ...
            <DialogFooter className="mt-4">
              ...
              <Button type="submit" disabled={loading}>
                {loading ? "Adding..." : "Add Academic Activity"}
              </Button>
            </DialogFooter>
          </form>
        </DialogContent>
