...
import { addEmployeeTypeFunc } from "../functions/EmployeeTypeFunctions";
import { EmployeeTypeDialogue } from "../components/EmployeeTypeDialogue";
...
const AddEmployeeTypes = ({ employeeTypes, accessToken }) => {
  ...
  const handleSubmit = async (title) => {
    ...
    setLoading(true);
    addEmployeeTypeFunc({ title, accessToken, setIsDialogOpen, setLoading });
  };
